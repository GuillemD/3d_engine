...
void Quadtree::SubDivide()
{
	...
	vec topcenter = { lenght_x / 2,lenght_y,lenght_z / 2 };
	...
	vec minchild1, maxchild1;
	minchild1 = quadtreeboundingbox->minPoint + vec(lenght_x*0.5f, 0.0f, 0.0f);
	maxchild1 = quadtreeboundingbox->minPoint + vec({ lenght_x,0.0f,lenght_z*0.5f});
	math::AABB tmp1(minchild1, maxchild1);
	childs[1] = new Quadtree(tmp1, nextsubdivision);

	vec minchild2, maxchild2;
	minchild2 = quadtreeboundingbox->minPoint + vec(0.0f, 0.0f, lenght_z*0.5f);
	maxchild2 = quadtreeboundingbox->minPoint + vec(lenght_x*0.5f, 0.0f, lenght_z);
	math::AABB tmp2(minchild2, maxchild2);
	childs[2] = new Quadtree(tmp2, nextsubdivision);

	vec minchild3, maxchild3;
	minchild3 = quadtreeboundingbox->minPoint + topcenter;
	maxchild3 = quadtreeboundingbox->minPoint + vec(lenght_x, 0.0f, lenght_z);
